import "./hero.css";
import heroImg from "../assets/images/home-hero-image_optimized.webp";
            ...
            <div className="col-lg-6 py-5">
              ...
              <div className="row mb-4 hero-bullets">
                <div className="col-4 d-flex align-items-center gap-2">
                  <svg className="ugb-custom-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" width="22" height="22" aria-hidden="true" >   <path     fill="#131117"     d="M9.8,13.3c-0.4,0.4-0.9,0.4-1.3,0L4.9,9.7c-0.3-0.4-0.3-0.9,0-1.3c0.3-0.3,0.9-0.3,1.2,0 l3,3l7.5-7.5C13.3,0.2,7.6,0,3.9,3.4S0,12.4,3.4,16.1s9.1,3.9,12.7,0.5c3.1-2.9,3.8-7.6,1.6-11.3L9.8,13.3z"   /> </svg>
              ...
              <button className="btn btn-danger px-4 py-2 hero-btn">
                EXPLORE SHOP
              </button>
            </div>
